...
public:
  ...
  float getSigma(const glm::vec3& V, glm::vec3& D)
  {
  ...
  // A FACE FACE!
  EnumCollisionType getCollisionType(const glm::mat3& C_ij, const sLastSeparatingAxis& lsa)
  {
  ...
  */
  void getCollisionPoint(const sLastSeparatingAxis& lsa, sCollisionPoint& colPoint, const glm::mat3& C_ij, const Object* obj)
  {
    const Object* A = this;
    const Object* B = obj;
  ...
  */
  bool checkCollision(Object* obj, sLastSeparatingAxis* lsa, bool* withinSphere, glm::mat3& C_ij)
  {
    ...
    C_ij = glm::transpose(AEdges) * BEdges;
  ...
  void calcCollision(Object* obj, sCollisionPoint& colPoint, glm::vec3& normal)
  {
    ...
    glm::mat3 I1 = this->getRotatedTensor();
    glm::mat3 I2 = obj->getRotatedTensor();
    glm::vec3 I1_calc = glm::inverse(I1) * (glm::cross(r_1, n));
    glm::vec3 I2_calc = glm::inverse(I2) * (glm::cross(r_2, n));
